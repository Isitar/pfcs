...
public class MyShaders {
    ...
    public static String vShader0 = "   #version 130                  /* Shader Language Version */   \n"
    ...
    public static String fShader0 = "    #version 130                   \n" + "    in  vec4 fColor;               \n"
            + "    out vec4 fragColor;            \n" + "    void main()                    \n"
            + "    {  fragColor = fColor;         \n" + "    }";

    /* ----------- Vertex-Shader mit Vertex-Transformationen */
    public static String vShader1 = "   #version 130                                                              \n"
    ...
    public static String vShader2 = "   #version 130                                         /* Shader Language Version */                \n"
    ...
    public static int initShaders(GL3 gl, String vShader, // Vertex-Shader
