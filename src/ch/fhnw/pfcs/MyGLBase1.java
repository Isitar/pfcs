...
public class MyGLBase1 {
    ...
    public MyGLBase1(GL3 gl, int programId, // Program-Identifier
    ...
    private void enableAttribute(GL3 gl, int attribId, String attribName, int size, int type, boolean normalized,
            int stride, int offset) // Aktivierung eines Vertex-Attributes
    {
        if (attribId >= 0) {
            ...
            System.out.println("Attribute " + attribName + " not enabled"); // Attribut-Var. im Vertex-Shader nicht
                                                                            // definiert
    }
    ...
    public float[] getCurrentColor() {
        float[] c = { currentColor[0], currentColor[1], currentColor[2] };
        return c;
    }

    public float[] getCurrentNormal() {
        float[] n = { currentNormal[0], currentNormal[1], currentNormal[2] };
        return n;
    }
